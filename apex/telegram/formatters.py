...
def format_help() -> str:
    return (
        "<b>APEX Commands</b>\n"
        "<b>Core:</b> /start /help /status /health /smoke\n"
        "<b>Markets:</b> /markets /scan /predict &lt;q&gt; /signals /arb\n"
        "<b>Betting:</b> /bet &lt;ticker&gt; &lt;YES|NO&gt; &lt;$&gt;\n"
        "  /positions /orders /fills /exposure /heat\n"
        "  /setstop &lt;ticker&gt; &lt;s%&gt; [t%] [tr%] /cancel_all\n"
        "<b>Accounting:</b> /pnl /bankroll /risk /diagnostics /costs\n"
        "<b>Crypto:</b> /crypto /predict_crypto &lt;COIN&gt; [hours]\n"
        "  /alerts set &lt;COIN&gt; &lt;above|below&gt; &lt;price&gt;\n"
        "  /alerts list · /alerts clear\n"
        "  /portfolio [COIN amount] · /watchlist [add|remove COIN]\n"
        "<b>AI:</b> /claude_score &lt;q&gt;\n"
        "<b>Modes:</b> /mode /modes /current_mode /autopilot [on|off]\n"
        "<b>Control:</b> /pause /resume /kill /paper_on /paper_off"
    )
